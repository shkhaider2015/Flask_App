...
from myApp.users.forms import RegistrationForm, LoginForm, UpdateAccountForm, RequestResetForm, ResetPasswordForm
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('An email has benn sent with instruction', 'info')
        return redirect(url_for('users.login'))
